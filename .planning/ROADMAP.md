...
- [ ] **Phase 1: Foundation** - Auth, roles, multi-tenant isolation, and trainer-trainee connections (gap closure in progress: plans 04-05)
...
|-------|----------------|--------|-----------|
| 1. Foundation | 4/5 | Gap closure in progress | 2026-03-09 |
