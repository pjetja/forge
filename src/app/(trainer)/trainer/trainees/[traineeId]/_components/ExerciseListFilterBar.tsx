...
interface ExerciseListFilterBarProps {
  initialQuery: string;
  initialMuscles: string[];
}

export function ExerciseListFilterBar({ initialQuery, initialMuscles }: ExerciseListFilterBarProps) {
  ...
  return (
    <div className="space-y-3 mb-6">
      ...
      <form onSubmit={handleSearch} className="flex gap-2">
        ...
        >
          {t('traineeDetail.exercises.search')}
        </button>
        <button
          type="button"
